...
python ligand_vdgs/generate_vdgs/vdg_generation_wrapper.py -s "[NX3,nX3]~1~[cX3,CX3]~[cX3,CX3]~[cX3,CX3]~[cX3,CX3]1" -c pyrrole -p /wynton/group/degradolab/skt/docking/databases/prepwizard_BioLiP2/ -b /wynton/group/degradolab/skt/docking/databases/probe_output/ -o /wynton/group/degradolab/skt/docking/databases/vdg_lib --symmetry-classes 0 1 2 2 1 -m 2000
